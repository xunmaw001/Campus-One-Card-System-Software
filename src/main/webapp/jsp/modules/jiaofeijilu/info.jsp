            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">缴费记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xfname" name="xfname" class="form-control"
                                               v-model="ruleForm.xfname" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xfmoney" name="xfmoney" class="form-control"
                                               v-model="ruleForm.xfmoney" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>消费时间</label>
                                        <input id="xiaofeiTime" name="xiaofeiTime" class="form-control"
                                               v-model="ruleForm.xiaofeiTime" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiaofeijilu/info/" + id,
