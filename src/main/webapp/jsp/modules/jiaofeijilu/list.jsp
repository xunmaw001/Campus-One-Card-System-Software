    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">缴费记录管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">缴费记录管理</li>
                        <li class="breadcrumb-item active">缴费记录列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">缴费记录列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                 
                                        <label>
                                            消费原因
                                            <input type="text" id="xfnameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="消费原因" aria-controls="tableId">
                                        </label>
...
<script>
    ...
    function search() {
        ...
        //消费原因
        var xfnameSearchInput = $('#xfnameSearch');
        if( xfnameSearchInput != null){
            if (xfnameSearchInput.val() != null && xfnameSearchInput.val() != '') {
                searchForm.xfname = $('#xfnameSearch').val();
            }
        }
                        getDataList();
    }
    ...
    function getDataList() {
        http("jiaofeijilu/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            xfname: searchForm.xfname,
            //级联表的
    ...
    function setDataRow(item, number) {
        ...
        //消费原因
        var xfnameCell = document.createElement('td');
        xfnameCell.innerHTML = item.xfname;
        row.appendChild(xfnameCell);


        //消费金额
        var xfmoneyCell = document.createElement('td');
        xfmoneyCell.innerHTML = item.xfmoney;
        row.appendChild(xfmoneyCell);


        //消费时间
        var xiaofeiTimeCell = document.createElement('td');
        xiaofeiTimeCell.innerHTML = item.xiaofeiTime;
        row.appendChild(xiaofeiTimeCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("jiaofeijilu/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addjiaofeijilu", "addjiaofeijilu");
        window.location.href = "add-or-update.jsp"
    }
