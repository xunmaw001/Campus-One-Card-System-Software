            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">签到设置</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input  id="kecheng" placeholder="请填入签到课堂" name="kecheng" class="form-control">
                            </div>
                        </div>
                        </br>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="add()" id="receive" class="btn btn-primary">签到</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            签到课堂
                                            <input type="text" id="qdnameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="签到课堂" aria-controls="tableId">
                                        </label>
                                                                                                
                                <button onclick="search()" type="button" class="btn btn-primary">查询</button>
                                <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-success 签到">签到</button>
...
<script>
    ...
    function search() {
        ...
        //签到课堂
        var qdnameSearchInput = $('#qdnameSearch');
        if( qdnameSearchInput != null){
            if (qdnameSearchInput.val() != null && qdnameSearchInput.val() != '') {
                searchForm.qdname = $('#qdnameSearch').val();
            }
        }
                    getDataList();
    }
    ...
    function setDataRow(item, number) {
        ...
        //签到课堂
        var qdnameCell = document.createElement('td');
        qdnameCell.innerHTML = item.qdname;
        row.appendChild(qdnameCell);
