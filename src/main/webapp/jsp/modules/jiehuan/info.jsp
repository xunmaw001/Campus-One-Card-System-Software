            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">设备借还登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>设备图片</label>
                                        <img id="sbimgPhotoImg" width="100" height="100">
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>租借时间</label>
                                        <input id="zhujieTime" name="zhujieTime" class="form-control"
                                               v-model="ruleForm.zhujieTime" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>租借状态</label>
                                    <input id="zhujieValue" name="zhujieValue" class="form-control"
                                           v-model="ruleForm.zhujieValue" readonly>
                                </div>
