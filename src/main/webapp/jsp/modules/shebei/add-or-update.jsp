                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                   ...
                                   <div class="form-group col-md-6">
                                       ...
                                       <input name="file" type="file" id="sbimgPhotoupload"
                                              class="form-control-file">
                                       <input name="sbimgPhoto" id="sbimgPhoto-input" type="hidden">
                                   </div>
                                   <%--<div class="form-group col-md-6">--%>
                                       <%--<label>设备状态</label>--%>
...
<script>
    ...
    function upload() {
        ...
        $('#sbimgPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('sbimgPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('sbimgPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                sbname: "设备名称不能为空",
                sbimgPhoto: "设备图片不能为空",
                shebeiTypes: "设备状态不能为空",
                tongzhiContent: "设备信息不能为空",
            }
        }).form();
    }
